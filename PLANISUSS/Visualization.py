            ...
            if cell.type == 'Water':
                ...
                if cell.vegetob:
                    ...
                    if cell.count_erbast():
                        ...
                        visualization_matrix[i, j] = [0, 0, max(0, 0.4 - 0.4*ratio)]  # dark blue for erbast


                if cell.count_carviz():
                    ratio = cell.count_carviz()/const.MAX_PRIDE
                    visualization_matrix[i, j] = [1, max(0, 0.5 - 0.5*ratio), max(0, 0.5 - 0.5*ratio)]  # red for carviz
